...
void OCRResult::SaveToImg(const std::string &save_path) {
  cv::Mat image = pipeline_result_.input_image;
...
void OCRResult::SaveToJson(const std::string &save_path) const {
  ...
  // Skip doc_preprocessor_res as we removed that functionality
  ...
  // Skip textline_orientation_angles as we removed that functionality
